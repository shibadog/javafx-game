...
@Slf4j
public class StickControllerInput implements ControllerInput {

    final Controller controller;

    volatile boolean button3Released;

    public StickControllerInput() {
        this.controller = ControllerInput.detectController(Controller.Type.STICK);
